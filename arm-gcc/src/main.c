/*==========================================================
 *
 *    Purpose: Implementing Finite State Machine and detecting a sequence.
 *                                                          
 *=========================================================*/
...
int main(void)
{
    ...
    //LED pins Output
    PyHal_GPIO_SetDir(21,1);//f
    PyHal_GPIO_SetDir(22,0);//a1
    PyHal_GPIO_SetDir(23,0);//a0
    PyHal_GPIO_SetDir(24,0);//b1
    PyHal_GPIO_SetDir(25,0);//b0
    
    
  
    
  
	uint32_t a1,a0,b1,b0,f;
    while(1)
    {	
    
    a1=PyHal_GPIO_Get(22);
    
    a0=PyHal_GPIO_Get(23);
    b1=PyHal_GPIO_Get(24);
    b0=PyHal_GPIO_Get(25);
